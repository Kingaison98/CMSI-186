...
public class Die {
   ...
   */
   public int roll() {
      double rollAmount = Math.random();
      rollAmount = rollAmount * sides;
      this.pips = (int)Math.ceil(rollAmount);
      //System.out.println("Rolled a " + pips + ".");
      return pips;
   }
  ...
  /**
   * Public Instance method that returns a String representation of THIS die instance by value
   * @return String representation of this Die by current value
   */
   public String toString() {
     String dieValue = "[" + this.getValue() + "]";
     return dieValue;
   }
  ...
  /**
   * Public Instance method that returns a String representation of THIS die instance by side
   * @return String representation by Sides
   */
   public String SidesToString() {
     String dieName = "[" + this.sides + "]";
     return dieName;
   }
   /**
    * Class-wide method that returns a String representation of THIS die instance by side
    * @return String representation by Sides
    */
   public static String SidesToString( Die d ) {
     return d.SidesToString();
   }
   ...
   */
   public static void main( String[] args ) {
      ...
      /*Die TestDie = new Die(8);
      System.out.println("Rolling " + TestDie.toString() + ". Classwide called " + toString(TestDie) + ".");
      TestDie.roll();
      System.out.println("Result is " + TestDie.getValue() + ".");*/
   }
