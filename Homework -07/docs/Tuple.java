 ...
 *  1.2.0  2018-04-20  Aison King    Added tuple(tuple t) constructor to allow creation of identical tuples.
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
public class Tuple {
   ...
   */
   ...
   /**
    * Constructs a tuple identical to the tuple passed in.
    *
    * @param t tuple used as argument
    *
    */
    public Tuple(Tuple t) {
      data = new int[t.length()];
      for(int i = 0; i < t.length(); i++) {
        data[i] = t.getElement(i);
      }
    }
